...
// own without the page ever scrolling horizontally on mobile (Principle VIII). The Actions
// column is empty in US1; the per-row Disable/Enable control fills it in US3.
