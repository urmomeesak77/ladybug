...
function HomePage() {
  ...
  return (
    <section aria-label="Memes">
      {/* The page's one top-level heading, screen-reader-only by request: the feed reads
          as self-explanatory to a sighted visitor, but crawlers and assistive tech still
          need the h1 (016 research D13). FeedItem titles sit at h2 below it, so the
          outline has no skipped level. */}
      <h1 className="sr-only">Newest memes</h1>
