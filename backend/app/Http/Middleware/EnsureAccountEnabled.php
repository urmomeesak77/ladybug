 ...
 * rotate the CSRF token — and answers 401 so the dead cookie cannot be replayed; the SPA
 * reads any non-ok /api/user probe as anonymous, so it drops to the logged-out UI with no new
 * client code. An active or unauthenticated request passes straight through.
 */
