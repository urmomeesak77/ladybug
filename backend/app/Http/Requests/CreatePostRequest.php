 ...
 * required; the image must be a real, bounded jpg/png/gif/webp and the YouTube value must parse
 * to a valid id. Authorization is the route's auth:sanctum middleware.
 */
class CreatePostRequest extends FormRequest {
    ...
    public function rules(): array {
        return [
            ...
            'image' => ['required_without:youtube', 'image', 'mimes:jpg,jpeg,png,gif,webp', 'max:10240'],
