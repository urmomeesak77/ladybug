...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Where the SPA lives. CORS allows this origin, and the email-verification
    | link wraps its signed API components in it so the message opens a site
    | page rather than a bare API response (research D3).
    |
    */
